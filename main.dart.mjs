...
_1665: x0 => x0.deref(),
_1671: Date.now,
_1673: s => new Date(s * 1000).getTimezoneOffset() * 60 ,
_1674: s => {
...
_1676: () => typeof dartUseDateNowForTicks !== "undefined",
_1677: () => 1000 * performance.now(),
_1678: () => Date.now(),
_1681: () => new WeakMap(),
_1682: (map, o) => map.get(o),
_1683: (map, o, v) => map.set(o, v),
_1684: () => globalThis.WeakRef,
_1694: s => stringToDartString(JSON.stringify(stringFromDartString(s))),
_1695: s => printToConsole(stringFromDartString(s)),
...
_1791: s => stringToDartString(stringFromDartString(s).toUpperCase()),
_1792: s => stringToDartString(stringFromDartString(s).toLowerCase()),
_1794: (s, m) => {
          try {
...
_1795: (x0,x1) => x0.exec(x1),
_1796: (x0,x1) => x0.test(x1),
_1797: (x0,x1) => x0.exec(x1),
_1798: (x0,x1) => x0.exec(x1),
_1799: x0 => x0.pop(),
_1803: (x0,x1,x2) => x0[x1] = x2,
_1805: o => o === undefined,
_1806: o => typeof o === 'boolean',
_1807: o => typeof o === 'number',
_1809: o => typeof o === 'string',
_1812: o => o instanceof Int8Array,
_1813: o => o instanceof Uint8Array,
_1814: o => o instanceof Uint8ClampedArray,
_1815: o => o instanceof Int16Array,
_1816: o => o instanceof Uint16Array,
_1817: o => o instanceof Int32Array,
_1818: o => o instanceof Uint32Array,
_1819: o => o instanceof Float32Array,
_1820: o => o instanceof Float64Array,
_1821: o => o instanceof ArrayBuffer,
_1822: o => o instanceof DataView,
_1823: o => o instanceof Array,
_1824: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
_1826: o => {
            const proto = Object.getPrototypeOf(o);
            return proto === Object.prototype || proto === null;
          },
_1827: o => o instanceof RegExp,
_1828: (l, r) => l === r,
_1829: o => o,
_1830: o => o,
_1831: o => o,
...
_1838: l => arrayFromDartList(Int8Array, l),
_1839: l => arrayFromDartList(Uint8Array, l),
_1840: l => arrayFromDartList(Uint8ClampedArray, l),
_1841: l => arrayFromDartList(Int16Array, l),
_1842: l => arrayFromDartList(Uint16Array, l),
_1843: l => arrayFromDartList(Int32Array, l),
_1844: l => arrayFromDartList(Uint32Array, l),
_1845: l => arrayFromDartList(Float32Array, l),
_1846: l => arrayFromDartList(Float64Array, l),
_1847: (data, length) => {
...
_1848: l => arrayFromDartList(Array, l),
_1849: stringFromDartString,
_1850: stringToDartString,
_1851: () => ({}),
_1852: () => [],
_1853: l => new Array(l),
_1854: () => globalThis,
_1855: (constructor, args) => {
...
_1857: (o, p) => o[p],
_1858: (o, p, v) => o[p] = v,
_1859: (o, m, a) => o[m].apply(o, a),
_1861: o => String(o),
_1862: (p, s, f) => p.then(s, f),
_1863: s => {
